...
int main(void)
{
   ...
   *
   * nitializes the Flash interface and the Systick. */
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  if(HAL_GetTick()>= timestamp){
		  if(MotorControlEnable == 1 ){
			  ...
			  else if((MotorSetRPM > MotorReadRPM)&&(MotorSetDuty <100)){
				  MotorSetDuty += 1;
			  }
		  }
		  ...
		  MotorReadRPM = (1/one_period__motor)*60;
